...
public class CurrencyConversionV2
{
    public static void main(String [ ] args)
    {
        ...
        double yenExchangeRate = 0.0;        // local variable for exchange rate of US Dollars to Yen
        ...
        double euroExchangeRate = 0.0;         // local variable for exchange rate of US Dollars to Euros
        ...
        //Mexico
        System.out.print("Please enter an exchange rate of US Dollars to Pesos:  ");
        pesoExchangeRate = in.nextDouble();
        System.out.println("You entered: " + pesoExchangeRate);
        System.out.println();
        
        //Japan
        
        System.out.print("Please enter an exchange rate of US Dollars to Yen:  ");
        yenExchangeRate = in.nextDouble();
        System.out.println("You entered: " + yenExchangeRate);
        System.out.println();
        
        //France
        System.out.print("Please enter an exchange rate of US Dollars to Euros:  ");
        euroExchangeRate = in.nextDouble();
        System.out.println("You entered: " + euroExchangeRate);
        System.out.println();
