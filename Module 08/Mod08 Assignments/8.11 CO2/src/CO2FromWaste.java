...
public class CO2FromWaste
{
    ...
    * @param myNumPeople number of people in a household
    ...
    */
   CO2FromWaste(int myNumPeople, boolean paper, boolean plastic, boolean glass, boolean cans)
   {
